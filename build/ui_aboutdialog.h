...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_cosmic_copyright = new QLabel(AboutDialog);
        label_cosmic_copyright->setObjectName(QString::fromUtf8("label_cosmic_copyright"));
        label_cosmic_copyright->setWordWrap(true);
        label_cosmic_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_cosmic_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About cosmic", 0, QApplication::UnicodeUTF8));
        label_3->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">cosmic</span></p></body></html>", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 cosmic Developers", 0, QApplication::UnicodeUTF8));
        label_cosmic_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2011-2014 cosmic Developers", 0, QApplication::UnicodeUTF8));
