...
// Copyright (c) 2012-2013 The cosmic developers
...
// cosmic version - intended for display purpose only
...
static const int PEERUNITY_VERSION =
                            100000 * PEERUNITY_VERSION_MAJOR
                         +    1000  * PEERUNITY_VERSION_MINOR
                         +      10 * PEERUNITY_VERSION_REVISION
                         +       1 * PEERUNITY_VERSION_BUILD;

// cosmic version - reference for code tracking
...
static const int PPCOIN_VERSION =
                            100000 * PPCOIN_VERSION_MAJOR
                         +    1000 * PPCOIN_VERSION_MINOR
                         +      10 * PPCOIN_VERSION_REVISION
                         +       1 * PPCOIN_VERSION_BUILD;

// bitcoin version - reference for code tracking
#define BITCOIN_VERSION_MAJOR       1
#define BITCOIN_VERSION_MINOR       1
#define BITCOIN_VERSION_REVISION    1
#define BITCOIN_VERSION_BUILD       1

static const int BITCOIN_VERSION =
                            100000 * BITCOIN_VERSION_MAJOR
                         +    1000 * BITCOIN_VERSION_MINOR 
                         +      10 * BITCOIN_VERSION_REVISION
...
static const int MIN_PROTO_VERSION = 49999;
