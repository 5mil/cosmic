 ...
 * The cosmic Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("cosmic Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/cosmic_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a cosmic address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/cosmic_tooltip"), tr("&About cosmic"), this);
    aboutAction->setToolTip(tr("Show information about cosmic"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for cosmic"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/cosmic_tooltip"), tr("Show/Hide &cosmic"), this);
    toggleHideAction->setToolTip(tr("Show or hide the cosmic window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/cosmic_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/cosmic_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/cosmic_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("cosmic client"));
    trayIcon->setIcon(QIcon(":/icons/cosmic_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cosmic network", "", count));
}
