...
// Copyright (c) 2014 The cosmic developers
...
// for both cosmicd and cosmic(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of cosmic releases, the client name should be selected from
