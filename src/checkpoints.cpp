...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 7000, uint256 ("0x0000000000002841e2037743d18921ff8029aae7834e72dae8e05b8a679f9d39"))
        ;
    ...
    // cosmic: synchronized checkpoint (centrally broadcasted)
    ...
    // cosmic: get last synchronized checkpoint
    ...
    // cosmic: only descendant of current sync-checkpoint is allowed
    ...
    // cosmic: reset synchronized checkpoint to last hardened checkpoint
...
// cosmic: sync-checkpoint master key
...
// cosmic: verify signature of sync-checkpoint message
...
// cosmic: process synchronized checkpoint
